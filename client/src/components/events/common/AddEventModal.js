            ...
            <Modal visible={true} onClickBackdrop={this.props.closeAddBookModal} dialogClassName="modal-lg">
                ...
                <div className="modal-body">
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-md-8">
                            <DateTimePicker onChange={this.handleStartDateChange} value={this.state.start_date} />
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-md-8">
                            <DateTimePicker onChange={this.handleEndDateChange} value={this.state.end_date} />
